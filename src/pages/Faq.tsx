    ...
    items: [
      {
        ...
        a: 'Разбор одного анализа стоит 150 рублей — это тариф «Разовая оплата». Также доступна подписка на 12 месяцев с медицинским дневником, графиками динамики и AI-чатом. Запрос отправляется в нейросеть только после подтверждения оплаты.',
      },
      {
