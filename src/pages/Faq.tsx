    ...
    items: [
      {
        ...
        a: 'Разбор одного анализа стоит 299 рублей — это тариф «Разовая оплата». Также доступны подписки на 3 и 12 месяцев с медицинским дневником, графиками динамики и AI-чатом. Запрос отправляется в нейросеть только после подтверждения оплаты.',
      },
      {
